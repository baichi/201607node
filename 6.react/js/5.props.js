...
var Rectangle = React.createClass({
    ...
    render(){
        return (
            <div style={{width:this.props.width,height:this.props.height,border:this.props.border}}>

            </div>
        )
    }
});
ReactDOM.render(<Rectangle width={100} height={100}/>, document.getElementById('app'))
